...
func writeJoinError(w http.ResponseWriter, err error) {
	...
	case errors.Is(err, service.ErrJoinRateLimited), errors.Is(err, service.ErrTooManyConnections):
		status = http.StatusTooManyRequests // 429
		headers["Retry-After"] = "60"

	case errors.Is(err, service.ErrGlobalCreatedRoomReached), errors.Is(err, service.ErrGlobalJoinedMemberReached):
