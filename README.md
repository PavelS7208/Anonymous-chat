...
- Обнаружены Go антипатерны, возвращаем из конструкторов интрфейсы, а не структуры; интерфейсы иногда объявлены по месту реализации, а не использования и т.д. Провести анализ и исправить.
